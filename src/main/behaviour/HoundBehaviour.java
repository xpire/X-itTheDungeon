...
//        int changeY = currLocation.getY() - playerLocation.getY();
        if (changeX != 0 && changeY != 0) {
            targetSquares.addAll(quadrantSweep(level,playerLocation,!(changeX>0),!(changeY>0)));
        } else if (changeX == 0) {
            targetSquares.addAll(verticalSweep(level,playerLocation,!(changeY>0)));
        } else if (changeY == 0) {
            targetSquares.addAll(horizontalSweep(level,playerLocation,!(changeX>0)));
        }
        return targetSquares;
    }
    ...
    public ArrayList<Vec2i> quadrantSweep(Level map, Vec2i playerLocation, Boolean increaseX, Boolean increaseY) {
    ...
    public ArrayList<Vec2i> verticalSweep(Level map, Vec2i playerLocation, Boolean increase) {
        int limit = 0;
        ArrayList<Vec2i> targetSquares = new ArrayList<>();
    ...
    public ArrayList<Vec2i> horizontalSweep(Level map, Vec2i playerLocation, Boolean increase) {
        int limit = 0;
        ArrayList<Vec2i> targetSquares = new ArrayList<>();
